...
<head runat="server">
    <title>Bulk Language Report</title>
    <style>
        body {
        ...
        protected void btnGetReport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (string ii in s)
                {
                    ...
                    {
                        lblMissingItems.Text += ii;
                        lblMissingItems.Text += "<br/>";
                    }
                }
    ...
    <form id="form1" runat="server">
        ...
        <table>
           ...
           <%-- </tr>
                ...
                <td style="width: 20%">Database:<asp:DropDownList ID="drpDB" runat="server">
            ...
            <tr>
                <td>
                    <asp:Label ID="lblMissingItems" runat="server"></asp:Label></td>
